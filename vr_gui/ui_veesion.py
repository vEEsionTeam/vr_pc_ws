...
################################################################################
## Form generated from reading UI file 'veesionQMFXED.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QRect(10, 10, 201, 251))
        ...
        self.frame_2.setGeometry(QRect(220, 10, 201, 251))
        ...
        self.tabWidget.setGeometry(QRect(10, 270, 411, 251))
        ...
        self.textBrowser.setGeometry(QRect(10, 10, 381, 192))
        self.tabWidget.addTab(self.tab_algorithm, "")
        self.tab_camimu = QWidget()
        self.tab_camimu.setObjectName(u"tab_camimu")
        self.textBrowser_5 = QTextBrowser(self.tab_camimu)
        self.textBrowser_5.setObjectName(u"textBrowser_5")
        self.textBrowser_5.setGeometry(QRect(10, 31, 181, 181))
        self.textBrowser_6 = QTextBrowser(self.tab_camimu)
        self.textBrowser_6.setObjectName(u"textBrowser_6")
        self.textBrowser_6.setGeometry(QRect(210, 31, 181, 181))
        self.label_19 = QLabel(self.tab_camimu)
        self.label_19.setObjectName(u"label_19")
        self.label_19.setGeometry(QRect(10, 10, 121, 17))
        self.label_20 = QLabel(self.tab_camimu)
        self.label_20.setObjectName(u"label_20")
        self.label_20.setGeometry(QRect(210, 10, 111, 17))
        self.tabWidget.addTab(self.tab_camimu, "")
        self.tab_comm = QWidget()
        self.tab_comm.setObjectName(u"tab_comm")
        self.label_22 = QLabel(self.tab_comm)
        self.label_22.setObjectName(u"label_22")
        self.label_22.setGeometry(QRect(210, 10, 111, 17))
        self.textBrowser_8 = QTextBrowser(self.tab_comm)
        self.textBrowser_8.setObjectName(u"textBrowser_8")
        self.textBrowser_8.setGeometry(QRect(10, 31, 181, 181))
        self.textBrowser_7 = QTextBrowser(self.tab_comm)
        self.textBrowser_7.setObjectName(u"textBrowser_7")
        self.textBrowser_7.setGeometry(QRect(210, 31, 181, 181))
        self.label_21 = QLabel(self.tab_comm)
        self.label_21.setObjectName(u"label_21")
        self.label_21.setGeometry(QRect(10, 10, 121, 17))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_algorithm), QCoreApplication.translate("MainWindow", u"Algorithm", None))
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"Camera terminal", None))
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"IMU terminal", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_camimu), QCoreApplication.translate("MainWindow", u"Camera and IMU", None))
        self.label_22.setText(QCoreApplication.translate("MainWindow", u"Client terminal", None))
        self.label_21.setText(QCoreApplication.translate("MainWindow", u"Server terminal", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_comm), QCoreApplication.translate("MainWindow", u"Communication", None))
    # retranslateUi
